...
module.exports = {
  config: {
    ...
    usages: [
      "box rename <tên> | avatar (reply ảnh)      — Đổi tên/ảnh nhóm",
      "box link on|off | setting <cai_dat> on|off  — Link mời/quyền thành viên",
      "box owner|block|unblock|blocklist [@tag]    — Phân quyền/chặn thành viên",
      "box upgrade | disperse                      — Nâng cấp / giải tán nhóm",
    ].join("\n"),
    cooldowns: 5,
  },
