...
module.exports = {
  config: {
    ...
    usages: [
      "admin list|info                          — Danh sách admin / thông tin hệ thống",
      "admin add|remove <uid/@>                 — Thêm/xoá admin bot",
      "admin setprefix <ký tự> | setname <tên>  — Đổi prefix / đổi tên bot",
      "admin bc <nội dung>                      — Broadcast tới tất cả nhóm",
      "admin kick <uid/@> | tang <@mention>     — Kick thành viên / lấy ID",
    ].join("\n"),
    cooldowns: 3,
  },
