...
module.exports = {
  config: {
    ...
    usages: [
      "friend find <sdt> | phones <sdt,...>            — Tìm theo SĐT",
      "friend all|online|close|suggest                  — Danh sách bạn bè",
      "friend add|accept|reject|undo|remove @tag/<uid>  — Quản lý kết bạn",
      "friend block|unblock @tag/<uid>                  — Chặn/bỏ chặn",
      "friend lastonline|alias|unalias @tag [biệt danh] — Online/biệt danh",
    ].join("\n"),
    cooldowns: 5,
  },
