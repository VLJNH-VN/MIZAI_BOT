...
module.exports = {
  config: {
    ...
    usages: [
      "botprofile name|bio|avatar <...>   — Đổi tên / bio / avatar bot (avatar: reply ảnh)",
      "botprofile online|offline           — Bật/tắt trạng thái online",
      "botprofile qr [uid]                 — Lấy QR code tài khoản",
    ].join("\n"),
    cooldowns: 10,
  },
